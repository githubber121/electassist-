...
export default function ChatPage() {
  ...
  return (
    <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full p-4 md:p-6 h-[calc(100vh-4rem)]">
      ...
      <div className="flex-1 overflow-y-auto bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-4 md:p-6 shadow-2xl flex flex-col custom-scrollbar">
        {messages.length === 0 ? (
          ...
          <div className="flex-1 flex flex-col">
            ...
            {isLoading && (
              <div className="flex items-center gap-2 text-slate-500 mb-6 ml-4">
